...
补充（2026-09-24 v1.9）：部门说明加篇幅上限和复核、关闭 Open WebUI 个人记忆、长对话提示、
      部门终端守护（命令超时终止、清理临时文件）、工具输出截断，详见《本机测试说明.txt》第十一节。
补充（2026-09-24 v1.9.1）：NAS 上不再构建终端镜像，Container Manager「停止 → 构建」可直接用，详见第十二节。
注意：.env 含密钥，不要外发。
